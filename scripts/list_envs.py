...
All the environments are registered in the `wheel_leg_rl` extension. They start
...
import wheel_leg_rl.tasks  # noqa: F401


def main():
    """Print all environments registered in `wheel_leg_rl` extension."""
