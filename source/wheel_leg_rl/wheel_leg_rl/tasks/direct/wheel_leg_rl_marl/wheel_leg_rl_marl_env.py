...
from .wheel_leg_rl_marl_env_cfg import WheelLegRlMarlEnvCfg


class WheelLegRlMarlEnv(DirectMARLEnv):
    cfg: WheelLegRlMarlEnvCfg

    def __init__(self, cfg: WheelLegRlMarlEnvCfg, render_mode: str | None = None, **kwargs):
