...
from wheel_leg_rl.env_cfg.wheelleg import WHEELLEG_CFG
...
@configclass
class WheelLegRlSceneCfg(InteractiveSceneCfg):
...
@configclass
class WheelLegRlEnvCfg(ManagerBasedRLEnvCfg):
    # Scene settings
    scene: WheelLegRlSceneCfg = WheelLegRlSceneCfg(num_envs=4096, env_spacing=4.0)
    # Basic settings
